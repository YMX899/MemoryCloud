...
<sub>💡 备注：服务已开源，可自行部署；如果不想维护服务器、备份、HTTPS、监控和邮件短信服务，建议直接使用 MemoryCloud Cloud。</sub>
...
<sub>💡 Note: MemoryCloud Community is open source and self-hostable. Use MemoryCloud Cloud if you prefer zero server maintenance, backups, HTTPS, monitoring, email, and SMS operations.</sub>
